...
then
    ...
    xterm -title "Celery" -e "cd $script_full_path; conda activate artic-ncov2019;celery worker -A main.celery --concurrency=1 --loglevel=info" 
...
then
    ...
    osascript -e 'tell application "Terminal" to do script "cd '$script_full_path';conda activate artic-ncov2019;celery worker -A main.celery --concurrency=1 --loglevel=info"' 
...
then
    ...
    konsole -e "cd $script_full_path; conda activate artic-ncov2019;celery worker -A main.celery --concurrency=1 --loglevel=info" 
